    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            firstName: Yup.string()
                .min(8)
                .required("Minimum Length Must be 8 characters"),
            lastName: Yup.string()
                .min(8)
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <div className="div4">
                <TextField
                    ...
                    onChange={formik.handleChange}
                    error={formik.touched.addr2 && Boolean(formik.errors.addr2)}
                    helperText={formik.touched.addr2 && formik.errors.addr2}
                />
            </div>
            <div className="div5">
                <TextField
            ...
            <div className="div6">
                <TextField
                    ...
                    onChange={formik.handleChange}
                    error={formik.touched.stateregion && Boolean(formik.errors.stateregion)}
            ...
            <div className="div9">
                <Checkbox defaultChecked />Use this address for payment details
            </div>
            <div className="div10">
